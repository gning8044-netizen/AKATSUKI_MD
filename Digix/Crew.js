    ...
    sock.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            try {
                ...
                const messageText = `
╔══════════════════╗
      *𝐀𝐊𝐀𝐓𝐒𝐔𝐊𝐈_𝐌𝐃🥀 𝐁𝐨𝐭 𝐂𝐨𝐧𝐧𝐞𝐜𝐭𝐞𝐝 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲* 😂
╠══════════════════╣
> "𝐁𝐨𝐭 𝐀𝐊𝐀𝐓𝐒𝐔𝐊𝐈 𝐜𝐫é𝐞 𝐩𝐚𝐫 𝐒𝐡𝐚𝐝𝐨𝐰 𝐚𝐤𝐚𝐭𝐬𝐮𝐤𝐢."
╚══════════════════╝
...
*𝐀𝐊𝐀𝐓𝐒𝐔𝐊𝐈_𝐌𝐃🥀*
                ...
                await sock.sendMessage(chatId, {
                    image: { url: imagePath },
                    caption: messageText,
                    footer: '💻 Powered by 𝐒𝐇𝐀𝐃𝐎𝐖 𝐀𝐊𝐀𝐓𝐒𝐔𝐊𝐈',
                });
    ...
    setTimeout(async () => {
        if (!state.creds.registered) {
            ...
            try {
                ...
                const code = await sock.requestPairingCode(number, 'AKATSUKI');
